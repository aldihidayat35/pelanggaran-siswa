...
<head>
    ...
    <style>
        ...
        table.data th, table.data td { border: 1px solid #444; padding: 4px 6px; font-size: 9px; vertical-align: top; }
...
<body>
            ...
            <tr>
                <td style="width:50%;">
                    @if($tanggalMulai && $tanggalSelesai)
                        <strong>Periode:</strong> {{ \Carbon\Carbon::parse($tanggalMulai)->format('d/m/Y') }} s.d. {{ \Carbon\Carbon::parse($tanggalSelesai)->format('d/m/Y') }}
                    @else
    ...
    <table class="data">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="{{ count($headers) + 1 }}" class="empty">Tidak ada data pelanggaran siswa pada periode ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
